#include "pendingapprovalslist.h"
#include "ui_pendingapprovalslist.h"

PendingApprovalsList::PendingApprovalsList(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::PendingApprovalsList)
{
    ui->setupUi(this);
...
void PendingApprovalsList::setTable()
{
    ...
    for(GeneralVoucherDataObject obj:voucherList){
        i=0;
        if(obj.status==QuotationStatus::ClientApprovedQuoatation){
