#ifndef PROFORMAINVOICEEDITOR_H
#define PROFORMAINVOICEEDITOR_H
...
class ProformaInvoiceEditor : public InventoryLedgerTransactionsEditor
{
    Q_OBJECT

public:
    explicit ProformaInvoiceEditor(VoucherDBAbstract *dbHelper,InventoryLedgerTransactionsEditor *parent = nullptr);
