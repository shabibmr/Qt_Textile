#ifndef REPORTCOMMONDELEGATE_H
#define REPORTCOMMONDELEGATE_H
...
class ReportCommonDelegate : public QStyledItemDelegate
{
public:
    ReportCommonDelegate();
protected:
