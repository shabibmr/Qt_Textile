#include "stockentrydelegate.h"
#include <QtGui>
#include <QApplication>
#include "customwidgets/Material/components/lib/qtmaterialtheme.h"

StockEntryDelegate::StockEntryDelegate(SalesInventoryItemDatabaseHelper *iHelper, QSqlQueryModel *model, UomDataBaseHelper *uHelper)
{
    this->model = model;
...
StockEntryDelegate::~StockEntryDelegate()
{

}

void StockEntryDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const
{
...
QWidget *StockEntryDelegate::createEditor(QWidget *parent, const QStyleOptionViewItem &option, const QModelIndex &index) const
{
    switch (index.column())
    {
    ...
    { GMInventoryItemSearch *itemLine = new GMInventoryItemSearch(itemHelper,model);
        ...
        QObject::connect(itemLine, &GMInventoryItemSearch::itemSelected,
                         this, &StockEntryDelegate::commitAndCloseItemEditor);
        return itemLine;
        break;
    }
...
//                this,&StockEntryDelegate::deleteButtonClicked);
        return button;
        break;
    }
    case 6:
    {
        ...
        connect(button,&QToolButton::clicked,
                ...
                &StockEntryDelegate::moreButtonClicked);
        return button;
...
void StockEntryDelegate::moreButtonClicked()
{
...
void StockEntryDelegate::setEditorData(QWidget *editor, const QModelIndex &index) const
{
    switch (index.column()) {
    case 1:{
        QString value;
...
void StockEntryDelegate::setModelData(QWidget *editor, QAbstractItemModel *model, const QModelIndex &index) const
{
    switch (index.column()) {
    case 1:
    {
...
bool StockEntryDelegate::editorEvent(QEvent *event, QAbstractItemModel *model, const QStyleOptionViewItem &option, const QModelIndex &index)
{
...
void StockEntryDelegate::updateEditorGeometry(QWidget *editor, const QStyleOptionViewItem &option, const QModelIndex &index) const
{
    editor->setGeometry(option.rect);
}

void StockEntryDelegate::commitAndCloseItemEditor(QModelIndex index)
{
...
void StockEntryDelegate::deleteButtonClicked()
{
