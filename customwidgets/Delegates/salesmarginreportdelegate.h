#ifndef SALESMARGINREPORTDELEGATE_H
#define SALESMARGINREPORTDELEGATE_H

#include <QStyledItemDelegate>
#include <QPainter>
#include <QApplication>

class SalesMarginReportDelegate : public QStyledItemDelegate
{
public:
    SalesMarginReportDelegate();
...
#endif // SALESMARGINREPORTDELEGATE_H
