#include "ledgerwisetableview.h"

LedgerwiseTableView::LedgerwiseTableView(GeneralVoucherDataObject *obj, int Type, QTableView *parent)
    :QTableView (parent)
{
    voucher = obj;
    ...
    connect(horizontalHeader(),&QHeaderView::sectionResized, this,
            &LedgerwiseTableView::updateSectionWidth);
}

LedgerwiseTableView::~LedgerwiseTableView(){}

void LedgerwiseTableView::setRowName(const QString &value)
{
    RowName = value;
    if(colorCount()>1){
...
void LedgerwiseTableView::setAvlcols(const QList<int> &value)
{
    avlcols = value;
}

void LedgerwiseTableView::setColumns()
{
...
void LedgerwiseTableView::setValues()
{
...
void LedgerwiseTableView::updateSectionWidth(int logicalIndex, int /* oldSize */, int newSize)
{
    lastRow->setColumnWidth(logicalIndex, newSize);
    updateLastRowGeometry();
}

void LedgerwiseTableView::setFocusAfterInsert(int row)
{
...
void LedgerwiseTableView::resizeEvent(QResizeEvent *event)
{
...
void LedgerwiseTableView::setVoucher(GeneralVoucherDataObject *value)
{
    voucher = value;
    setValues();
}
...
void LedgerwiseTableView::updateLastRowGeometry()
{
    QRect rect = this->geometry();
