#ifndef PAYSLIPTABLEVIEW_H
#define PAYSLIPTABLEVIEW_H
...
class PayslipTableView : public QTableView
{
    Q_OBJECT
...
public:
    explicit PayslipTableView(AttendanceListDataModel *obj, QTableView *parent= Q_NULLPTR);
    virtual ~PayslipTableView() override;
...
//    QTableWidget *lastRow;
    ...
    void setVoucher(AttendanceListDataModel *value);
...
protected:
    ...
    AttendanceListDataModel *voucher;
