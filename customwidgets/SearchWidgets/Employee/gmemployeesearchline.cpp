#include "gmemployeesearchline.h"




GMEmployeeSearchLine::GMEmployeeSearchLine(UserProfileDatabaseHelper *iHelper,
                                           QSqlQueryModel *m,QLineEdit *parent)
    :QLineEdit (parent)
{
    srcModel = m;
    userHelper = iHelper;
    ...
    QObject::connect(this,&QLineEdit::editingFinished,
                     this,&GMEmployeeSearchLine::finishEdit);

    QObject::connect(this,&QLineEdit::returnPressed,
                     this,&GMEmployeeSearchLine::finishEditByRet);
    this->setCompleter(gmcompleter);
}

GMEmployeeSearchLine::~GMEmployeeSearchLine()
{

}

void GMEmployeeSearchLine::setItem(const UserProfileDataModel &value)
{
    item = value;
    this->setText(item.Name);
}

void GMEmployeeSearchLine::setNewText(QString text, QString id)
{

}
bool GMEmployeeSearchLine::eventFilter(QObject *obj, QEvent *event)
{
    {
...
void GMEmployeeSearchLine::sendPositiveEMIT(QModelIndex index, int itemID)
{
    activated = false;
...
void GMEmployeeSearchLine::completerhighlighted(QModelIndex index)
{
    emit currentSelection(index);
}

void GMEmployeeSearchLine::completerActivated(QModelIndex index)
{
    if(index.isValid()){
...
void GMEmployeeSearchLine::finishEditByRet()
{
    //    qDebug()<<"finish Edit";
    //    if(activated){
    //        activated = false;
...
void GMEmployeeSearchLine::finishEdit()
{
    //    qDebug()<<"finish Edit";
    //    if(activated){
    //        activated = false;
...
void GMEmployeeSearchLine::paintEvent(QPaintEvent *event)
{
