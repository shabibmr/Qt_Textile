#ifndef GODOWNSEARCHDELEGATE_H
#define GODOWNSEARCHDELEGATE_H

#include <QStyledItemDelegate>
#include <QPainter>


class GodownSearchDelegate: public QStyledItemDelegate
{
public:
    GodownSearchDelegate();
