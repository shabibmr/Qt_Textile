#include "gmledgersearchdelegate.h"

GMLedgerSearchDelegate::GMLedgerSearchDelegate()
{

}

void GMLedgerSearchDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const
{
    ...
    QString line2 = index.model()->data(index.model()->index(index.row(), 3)).toString();
...
QSize GMLedgerSearchDelegate::sizeHint(const QStyleOptionViewItem &option, const QModelIndex &index) const
{
