#ifndef GMSTOCKJOURNALMODEL_H
#define GMSTOCKJOURNALMODEL_H
...
class GMStockJournalModel : public QAbstractItemModel
{
    Q_OBJECT

public:
    explicit GMStockJournalModel(GeneralVoucherDataObject *voucher,int col, QObject *parent = nullptr);
