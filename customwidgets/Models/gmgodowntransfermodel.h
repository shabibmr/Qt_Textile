#ifndef GMGODOWNTRANSFERMODEL_H
#define GMGODOWNTRANSFERMODEL_H
...
class GMGodownTransferModel :  public QAbstractItemModel
{
    Q_OBJECT

public:
    explicit GMGodownTransferModel(GeneralVoucherDataObject *voucher,int col, QObject *parent = nullptr);

    ~GMGodownTransferModel();
