#ifndef GMPAYMENTENTRYMODEL_H
#define GMPAYMENTENTRYMODEL_H
...
class GMPaymentEntryModel : public QAbstractItemModel
{
    Q_OBJECT

public:
    explicit GMPaymentEntryModel(GeneralVoucherDataObject *voucher,int col, QObject *parent = nullptr);
