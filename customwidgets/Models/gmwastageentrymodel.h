#ifndef GMWASTAGEENTRYMODEL_H
#define GMWASTAGEENTRYMODEL_H
...
class GMWastageEntryModel : public QAbstractItemModel
{
    Q_OBJECT

public:
    explicit GMWastageEntryModel(GeneralVoucherDataObject *voucher, int col,QObject *parent = nullptr);
