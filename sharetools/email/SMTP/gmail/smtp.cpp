...
void Smtp::errorReceived(QAbstractSocket::SocketError socketError)
{
    ...
    QMessageBox box; box.setText(" Error : " + socket->errorString());
...
void Smtp::readyRead()
{
    ...
    else if ( state == Quit && responseLine == "250" )
    {
        ...
        *t << "QUIT\r\n";
        ...
        // here, we just close.
        state = Close;
//        QMessageBox box; box.setText("Message sent to " + rcpt); box.exec();
...
//        QMessageBox::warning( 0, tr( "Qt Simple SMTP client" ), tr( "Unexpected reply from SMTP server:\n\n" ) + response );
        state = Close;
//        QMessageBox box; box.setText("Failed to send message"); box.exec();
