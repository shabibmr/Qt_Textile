#ifndef PROFORMADATABASEHELPER_H
#define PROFORMADATABASEHELPER_H
...
class ProformaDatabaseHelper : public VoucherDBAbstract
{
public:
    ProformaDatabaseHelper(QString connString=DatabaseValues::connectionString);
    ~ProformaDatabaseHelper();
    ...
    QString Sales_Invoice_Details_TableName = "Proforma_Details";
    ...
    QString VoucherType = GMVoucherTypes::getVoucherString(GMVoucherTypes::Proforma);// "PROFORMA";
    ...
    QSqlQueryModel *getVoucherListByDateTimeModel(QDateTime,QDateTime);
...
#endif // PROFORMADATABASEHELPER_H
