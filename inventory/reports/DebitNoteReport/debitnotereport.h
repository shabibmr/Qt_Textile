#ifndef DEBITNOTEREPORT_H
#define DEBITNOTEREPORT_H
...
class DebitNoteReport : public QWidget
{
    Q_OBJECT

public:
    explicit DebitNoteReport(QWidget *parent = 0);
    ~DebitNoteReport();
...
private:
    Ui::DebitNoteReport *ui;
};

#endif // DEBITNOTEREPORT_H
